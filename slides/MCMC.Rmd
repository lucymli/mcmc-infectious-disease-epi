...
1. Install R Studio if you haven't done so already.
2. Install the \texttt{swirl} package: Open R Studio, then type \texttt{install.packages("swirl")}).
3. Install course material from GitHub: Type \texttt{swirl::install_course_github}
